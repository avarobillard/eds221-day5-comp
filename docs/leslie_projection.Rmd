...
# The line below creates a time series of years
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below sets up a matrix with columns for population types and rows for time steps 
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below fills in the first row with initial populations
proj_year[1, ] <- fish_year0

# The for loop below iteratively adds the following years to the matrix based on previous year 
